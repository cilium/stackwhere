...
```bash
wget https://github.com/cilium/stackwhere/releases/download/v0.3.0/stackwhere_0.3.0_linux_amd64.tar.gz

# Optional, verify checksum
wget https://github.com/cilium/stackwhere/releases/download/v0.3.0/stackwhere_0.3.0_checksums.txt
sha256sum -c stackwhere_0.3.0_checksums.txt --ignore-missing
# Should say: stackwhere_0.3.0_linux_amd64.tar.gz: OK

tar -xzf stackwhere_0.3.0_linux_amd64.tar.gz
